...
func TestTwoSum(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.TwoSum(tt.args.nums, tt.args.target); !reflect.DeepEqual(got, tt.want) {
...
func TestAddTwoNumbers(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "test 1", args: args{l1: nil, l2: nil}, want: nil},
		{
			...
			args: args{
				l1: &leet.ListNode{
					Val: 2, Next: &leet.ListNode{
						Val: 4, Next: &leet.ListNode{
							Val: 3}}},
				l2: &leet.ListNode{
					Val: 5, Next: &leet.ListNode{
						Val: 6, Next: &leet.ListNode{
							Val: 4}}}},
			want: &leet.ListNode{
				Val: 7, Next: &leet.ListNode{
					Val: 0, Next: &leet.ListNode{
						Val: 8}}},
		},
		{
			name: "test 3",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.AddTwoNumbers(tt.args.l1, tt.args.l2); !reflect.DeepEqual(got, tt.want) {
...
func TestLengthOfLongestSubstring(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.LengthOfLongestSubstring(tt.args.s); got != tt.want {
...
func TestIsPalindrome(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.IsPalindromeNumber(tt.args.x); got != tt.want {
...
func TestRomanToInt(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.RomanToInt(tt.args.s); got != tt.want {
...
func TestLongestCommonPrefix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.LongestCommonPrefix(tt.args.strs); got != tt.want {
...
func TestIsValidParens(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.IsValidParens(tt.args.s); got != tt.want {
...
func TestRemoveDuplicates(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := leet.RemoveDuplicates(tt.args.nums); got != len(tt.want) {
